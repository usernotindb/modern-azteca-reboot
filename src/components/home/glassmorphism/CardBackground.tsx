  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{
          transform: isMobile ? "none" : `translateX(${mouseX * 0.02}px) translateY(${mouseY * 0.02}px)`,
        }}
      />
      ...
      <div 
        ...
        style={{
          ...
          transform: isMobile ? "none" : `translateX(${mouseX * 0.03}px) translateY(${mouseY * 0.03}px) translateZ(20px)`,
          backgroundPosition: isMobile ? "center center" : `${50 + mouseX * 0.05}% ${50 + mouseY * 0.05}%`,
        }}
      />
      ...
      <div 
        ...
        style={{
          transform: isMobile ? "none" : `translateX(${mouseX * -0.01}px) translateY(${mouseY * -0.01}px)`,
        }}
      />
    </div>
  );
