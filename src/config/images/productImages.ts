...
export const PRODUCT_IMAGES: Record<string, ImageConfig> = {
  ...
  laptop2: {
    id: 'laptop-developer',
    path: "/lovable-uploads/laptop-developer.png",
  ...
  laptop3: {
    id: 'laptop-executive',
    path: "/lovable-uploads/laptop-executive.png",
  ...
  server1: {
    ...
    path: "/lovable-uploads/server-entry-level.png",
  ...
  server2: {
    id: 'server-mid-range',
    path: "/lovable-uploads/server-mid-range.png",
  ...
  server3: {
    ...
    path: "/lovable-uploads/server-enterprise.png",
  ...
  workstation1: {
    ...
    path: "/lovable-uploads/workstation-design.png",
  ...
  workstation2: {
    ...
    path: "/lovable-uploads/workstation-engineering.png",
  ...
  workstation3: {
    ...
    path: "/lovable-uploads/workstation-content.png",
