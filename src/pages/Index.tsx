  ...
  return (
    <Layout>
      ...
      >
        ...
        <section className="py-20 bg-aztec-50 overflow-hidden relative">
          <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-aztec-300 to-transparent"></div>
          <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-aztec-300 to-transparent"></div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <FadeIn direction="up" className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-aztec-600 text-lg">
                Hear from organizations that have transformed their IT operations with Azteca Technology.
              </p>
            </FadeIn>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <TestimonialCard 
                quote="Azteca Technology completely transformed our IT infrastructure. Their team's expertise and professionalism made the transition seamless, and we've seen significant improvements in performance and security."
                author="Maria Rodriguez"
                title="CTO, Global Innovations Inc."
              />
              <TestimonialCard 
                quote="The cybersecurity solutions provided by Azteca have given us peace of mind. Their proactive approach to security has prevented several potential incidents and their support team is always responsive."
                author="David Chen"
                title="IT Director, Financial Partners Group"
              />
            </div>
          </div>
        </section>
